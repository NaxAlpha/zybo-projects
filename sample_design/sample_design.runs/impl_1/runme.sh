...
HD_PWD='C:/Users/speci/vivado/sample_design/sample_design.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log design_2.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source design_2.tcl -notrace
