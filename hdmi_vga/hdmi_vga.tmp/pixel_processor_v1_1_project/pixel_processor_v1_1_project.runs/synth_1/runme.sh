...
HD_PWD='c:/users/speci/vivado/hdmi_vga/hdmi_vga.tmp/pixel_processor_v1_1_project/pixel_processor_v1_1_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pixel_processor.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pixel_processor.tcl
