...
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(clk_in, clk_out, pxl_in, hsync, vsync, pxl_out)
/* synthesis syn_black_box black_box_pad_pin="clk_in,clk_out,pxl_in[23:0],hsync,vsync,pxl_out[23:0]" */;
  input clk_in;
  output clk_out;
  input [23:0]pxl_in;
  output hsync;
