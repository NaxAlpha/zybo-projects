...
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(pxl_clk, mode, pxl_in, pxl_out)
/* synthesis syn_black_box black_box_pad_pin="pxl_clk,mode[3:0],pxl_in[23:0],pxl_out[23:0]" */;
  input pxl_clk;
  input [3:0]mode;
  input [23:0]pxl_in;
  output [23:0]pxl_out;
